  ...
  return (
    <div className='App'>
      <Router>
        ...
        <Products image={Cleaning} name='Cleaning & Janitorial' link='/cleaning'/>
        <Products image={Ship} name='Pak & Ship' link='/pak-an-ship'/>
        <Products image={Breakroom} name='Breakroom' link='/breakroom'/>
        <Products image={Bus} name='Business Essentials' link='/businessessential'/>
        <Banner />
        ...
        <Footer heading='Corporate Info'
          ...
          navlink4='/ourbrands'
          />
        <Footer heading='Staples Corporate Solutions'
